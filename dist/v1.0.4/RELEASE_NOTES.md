## TSENEX Bank Collector v1.0.4

- Windows x64 update package
- Recovers the KB corporate banking transaction page when certificate login returns a stale 404 URL
- Continues waiting when the KB certificate overlay is already open instead of failing on a duplicate click
- Retries the KB certificate login function after transient loading overlays disappear
